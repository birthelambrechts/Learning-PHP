...
switch ($_GET['hitButton']){
    ...
    $_SESSION['card'] =( $_SESSION['card'] + $random);
        ...
        if ($_SESSION['card'] = 21){
             return   $_SESSION['card'] . "You win!";  
        }
        if( $_SESSION['card'] >= 21){
            return   $_SESSION['card'] . "You lose!";  
        unset($_SESSION['card']);
        }
        return  " = " . $_SESSION['card'];
    break;
		...
		<div class="container">
			...
			<form method="post">
				<table align="center">
					...
					<tr>
                        <td colspan="<?=count($_SESSION['hand_player']) ?>" align="center">
                        <input type="submit" name="hit" class="btn btn-primary" value="Hit" /> || 
                        <input type="submit" name="stand" class="btn btn-primary" value="Stand" /></td>
					</tr>
					<tr height="100" valign="middle">
                        <td colspan="<?=count($_SESSION['hand_player']) ?>" align="center">
                        <input type="submit" name="reset" class="btn btn-primary" value="Reset" /></td>
					</tr>
				</table>
			</form>
		</div>
